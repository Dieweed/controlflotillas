...
var usuario='';
    $(document).ready(function(){
        ...
        salidas.ObtenerInventario();
    });

salidas.ObtenerInventario=function(){
       $.ajax({
...
salidas.cargaLocales = function(){   
    $("#gridArticulos").html('');
    $.each(articulos, function(i, item){
        salidas.insertaArticulo(item);
    });
}

salidas.insertaArticulo=function(item){
    var articulo='';
    ...
    if(item.tipo == 1){
        ...
        articulo+='<tr class="col-xs-12 sinPadding" onclick="salidas.dameArticulo(\''+item.idInventario+'\')">'+
                    '<td class="col-xs-12">'+
                        '<div class="col-xs-6">'+
...
salidas.dameArticulo=function(idInventario){
    $.each(articulos, function(i, item) {
